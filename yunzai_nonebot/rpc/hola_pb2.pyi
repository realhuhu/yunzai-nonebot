...
class Request(_message.Message):
    __slots__ = ["delete_message", "get_forward_message", "get_friend_list", "get_group_info", "get_group_list", "get_group_member_info", "get_group_member_list", "get_message", "get_self_info", "get_user_info", "request_id", "self_id", "send_like", "send_message", "set_friend_add_request", "set_group_add_request", "set_group_admin", "set_group_anonymous", "set_group_anonymous_ban", "set_group_ban", "set_group_card", "set_group_kick", "set_group_leave", "set_group_name", "set_group_special_title", "set_group_whole_ban"]
...
class SetGroupAnonymousBanRequest(_message.Message):
    __slots__ = ["anonymous", "anonymous_flag", "duration", "group_id"]
    ...
    duration: int
    group_id: int
    def __init__(self, group_id: _Optional[int] = ..., anonymous: _Optional[_Mapping[str, str]] = ..., anonymous_flag: _Optional[str] = ..., duration: _Optional[int] = ...) -> None: ...
...
class ToClient(_message.Message):
    __slots__ = ["option_code", "result"]
    OPTION_CODE_FIELD_NUMBER: _ClassVar[int]
    RESULT_FIELD_NUMBER: _ClassVar[int]
    option_code: OptionCode
    result: Result
    def __init__(self, result: _Optional[_Union[Result, _Mapping]] = ..., option_code: _Optional[_Union[OptionCode, _Mapping]] = ...) -> None: ...

class ToServer(_message.Message):
    __slots__ = ["event", "head", "option_code", "request"]
    ...
    option_code: OptionCode
    request: Request
    def __init__(self, head: _Optional[_Union[Head, _Mapping]] = ..., event: _Optional[_Union[Event, _Mapping]] = ..., request: _Optional[_Union[Request, _Mapping]] = ..., option_code: _Optional[_Union[OptionCode, _Mapping]] = ...) -> None: ...
